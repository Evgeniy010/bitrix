...
if ( $_POST['ACTION'] )
{
	if ( $_POST['TASK'] ){
		...
		$value = $USER_FIELD_MANAGER->GetUserFieldValue('TASKS_TASK', 'UF_AUTO_899851156396', (int) $_POST['TASK']) + $direction; 
		if ($value < 1)
		{
			echo 'fail';
			exit();
		}
		$ret = $USER_FIELD_MANAGER->Update('TASKS_TASK', $_POST['TASK'], array("UF_AUTO_899851156396" => $value)); 
